...
from ingestion.python_parser import ModuleInfo
from ingestion.sql_parser import SqlFileInfo
...
class GraphBuilder:
    ...
    def _ingest_python(self, info: ModuleInfo, file_path: str):
        ...
        for imp in info.imports:
            ...
            # "from ingestion.parser_dispatcher import ParsedFile" -> "ingestion/parser_dispatcher.py"
